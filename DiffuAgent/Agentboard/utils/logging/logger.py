...
class SummaryLogger:
    def __init__(self, log_path, baseline_dir= "data/baseline_results"):
        ...
        self.dimension_scoring = {
            "Memory": {"alfworld_enhanced": 1, "scienceworld_enhanced": 2, "babyai_enhanced": 1},
            "Planning": {"alfworld_enhanced": 1, "scienceworld_enhanced": 2, "babyai_enhanced": 2},
            "World Modeling": {"alfworld_enhanced": 3, "scienceworld_enhanced": 3, "babyai_enhanced": 2},
            "Self-reflection": {"alfworld_enhanced": 3, "scienceworld_enhanced": 2, "babyai_enhanced": 2},
            "Grounding": {"alfworld_enhanced": 2, "scienceworld_enhanced": 3, "babyai_enhanced": 2},
            "Spatial Navigation": {"alfworld_enhanced": 2, "scienceworld_enhanced": 2, "babyai_enhanced": 2}
        }  
...
class TaskLogger:
    ...
    # =====[ MODIFIED: Added 'extra' parameter for enhanced logging ]=====
    # 'extra' stores: steps, avg_tokens, stop_reason (max_steps/early_exit/success)
    def save_sample_data_to_file_detailed(self, id, is_done, reward, grounding_accuracy, score_change_record, env_details, trajectory, example_prompt, extra=None):
        ...
        # =====[ ADDED: Store extra record for enhanced tasks ]=====
    ...
    # =====[ MODIFIED: Added 'extra' parameter to pass extra_record ]=====
